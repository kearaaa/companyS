    ...
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
          ...
          <x-nav-link :href="route('perusahaan')" :active="request()->routeIs('perusahaan')">
            {{ __('Perusahaan') }}
          </x-nav-link>
          ...
          <x-nav-link :href="route('pemasok')" :active="request()->routeIs('pemasok')">
            {{ __('Pemasok') }}
          </x-nav-link>
                ...
                <div class="avatar">
                  <div class="w-10 rounded-full">
                    @if (Auth::user()->avatar)
                      ...
                      @endif
                    @else
                      <img src="assets/Default avatar icon vector of social media user.jpeg" alt="user profile">
                    @endif
                  </div>
                </div>
              </div>

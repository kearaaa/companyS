<x-app-layout>
  ...
  <dialog id="my_modal_3" class="modal">
    <div class="modal-box">
      ...
      <form action="{{ route('perusahaan') }}" method="post" autocomplete="off">
        @csrf
        <h2 class="text-2xl font-bold mb-4">Input Perusahaan</h2>
        <div class="mb-4">
          ...
          <input type="text" id="nama_perusahaan" name="nama_perusahaan" required
            class="border rounded-md py-2 px-3 w-full focus:outline-none focus:ring focus:border-blue-300 bg-slate-500 text-white" value="{{ old('nama_perusahaan') }}">
              ...
              @foreach ($perusahaan as $data)
                <tr class="border-b">
                  ...
                  <td class="space-x-2">
                    ...
                    <a href="{{ route('perusahaan.edit', $data->id_perusahaan) }}"
                      class="text-blue-500 hover:underline">Edit</a>
                    <a href="{{ route('perusahaan.destroy', $data->id_perusahaan) }}"

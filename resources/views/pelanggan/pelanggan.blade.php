<x-app-layout>
  ...
  <dialog id="my_modal_3" class="modal">
    <div class="modal-box">
      ...
      <form action="{{ route('pelanggan') }}" method="post" autocomplete="off">
        @csrf
        <h2 class="text-2xl font-bold mb-4">Input Pelanggan</h2>
        <div class="mb-4">
              ...
              @foreach ($pelanggan as $data)
                <tr class="border-b">
                  ...
                  <td class="space-x-2">
                    ...
                    <a href="{{ route('pelanggan.edit', $data->id_pelanggan) }}"
                      class="text-blue-500 hover:underline">Edit</a>
                    <a href="{{ route('pelanggan.destroy', $data->id_pelanggan) }}"
